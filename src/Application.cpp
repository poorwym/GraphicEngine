...
static void LoadModel(SceneManager& g_SceneManager) {
    ...
    MeshComponent* meshComponent1 = resourceManager.LoadOBJ("res/Obj/bust/", "bust.obj", 0.3f);
    ...
    //SceneNode* node1 = resourceManager.LodeGLTF("res/gltf/Fairy/", "Wild Fantasy Fairy.gltf", 20.0f);
